          ...
          children: [
            const GradientBackground(
              children: [
                ...
                Text(AppStrings.register, style: AppTheme.title_Large),
                SizedBox(height: 6),
                Text(AppStrings.createYourAccount, style: AppTheme.body_Small),
              ],
            ),
            const SizedBox(
              height: 40,
            ...
            Row(
              ...
              children: [
                Text(
                  ...
                  style: AppTheme.body_Small.copyWith(color: Colors.black),
                ),
                TextButton(
